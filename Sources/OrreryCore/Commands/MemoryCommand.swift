...
/// `orrery memory …` — manage shared project memory (top-level; not scoped
/// under `orrery workspace`, since memory is shared across environments).
...
// MARK: - Memory migration / storage helpers (used by MemoryCommand subcommands)
