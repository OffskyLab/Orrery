...
struct ClaudeKeychainTests {
    ...
    func hashedService() {
        ...
        let cases: [(path: String, hash: String)] = [
            ...
            ("/Users/gradyzhuo/.orrery/envs/B761FD59-BCCF-4BB0-AAFF-DE3DCABB882B/claude", "41b1e824"),
            ("/Users/gradyzhuo/.orrery/envs/1001BA2F-5CE8-4125-A36A-C753B517B8ED/claude", "bc6e326e"),
        ]
        for c in cases {
